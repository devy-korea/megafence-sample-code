    ...
    */
    ...
    function WG_GetWaitingUi($service_id, $gate_id)
    {
		...
		$html = "<!DOCTYPE html>\r\n"
            ...
            . "    <link href='https://cdn.devy.kr/WG_SERVICE_ID/css/webgate.css?v=210629' rel='stylesheet'>\r\n"
            . "    <script type='text/javascript' src='https://cdn.devy.kr/WG_SERVICE_ID/js/webgate.js?v=210629'></script>\r\n"
            . "    <script>\r\n"
